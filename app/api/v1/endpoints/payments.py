...
from app.schemas.payment import PaymentCreate, Payment as PaymentSchema, LoanLedgerSummary
...
async def create_payment(
    ...
    """
    # Process payment
    received_by = current_user if current_user.role in [UserRole.ADMIN, UserRole.EMPLOYEE] else None
...
async def get_loan_ledger(
    ...
    return LoanLedgerSummary(
        ...
        total_interest=loan.outstanding_interest + (loan.total_paid - loan.outstanding_principal),
