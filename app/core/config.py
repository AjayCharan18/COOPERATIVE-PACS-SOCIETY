...
class Settings(BaseSettings):
    # App Settings
    APP_NAME: str = Field(default="COOPERATIVE PACS Loan Automation AI System", env="APP_NAME")
    ...
    SECRET_KEY: str = Field(
        default="GKAUQiSuMPq-Bh8zmNYVtOD9JYcAbvd6x8-KvXMGVMg",
        env="SECRET_KEY"
    )
    ALGORITHM: str = Field(default="HS256", env="ALGORITHM")
    ACCESS_TOKEN_EXPIRE_MINUTES: int = Field(default=0, env="ACCESS_TOKEN_EXPIRE_MINUTES")  # 0 means non-expiring
    ...
    GEMINI_API_KEY: str = Field(
        default="AIzaSyDYv5Wrh4Fd2nBHbriJIaw7ftgPmyY5jKo",
        env="GEMINI_API_KEY"
    )
    ...
    EMAIL_FROM: str = Field(default="COOPERATIVE PACS Loan Alerts <noreply@cooperativepacs.com>", env="EMAIL_FROM")
