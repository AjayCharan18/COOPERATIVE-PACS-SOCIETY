...
class User(Base, TimestampMixin):
    ...
    farmer_id = Column(String(20), unique=True, nullable=True, index=True)  # Unique ID for farmers
    ...
    payments = relationship("Payment", back_populates="paid_by_user", foreign_keys="Payment.paid_by_user_id")
