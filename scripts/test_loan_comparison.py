    ...
    test_cases = [
        {
            ...
            "data": {
                ...
                "tenure_months": 12,
                "loan_types": ["sao", "long_term_emi", "rythu_bandhu", "rythu_nethany", "amul_loan"]
            }
        },
        {
    ...
    for test in test_cases:
        ...
        if response.status_code == 200:
            ...
            if len(result['comparisons']) > 1:
                ...
                print(f"\n[SAVINGS ANALYSIS]")
                print(f"Best: {best['name']} - Rs {best['total_interest']:,.2f} interest")
                print(f"Worst: {worst['name']} - Rs {worst['total_interest']:,.2f} interest")
